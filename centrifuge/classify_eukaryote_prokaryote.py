...
if __name__ == '__main__':
    ...
    final_bac.to_csv("./centifuge_output/centrifuge_metagenome_table_bac.txt", sep="\t")
    ...
    final_vir.to_csv("./centifuge_output/centrifuge_metagenome_table_virus.txt", sep="\t")
    final_arc=generate_table(metagenome_list, archaea)
    final_arc.to_csv("./centifuge_output/centrifuge_metagenome_table_archaea.txt", sep="\t")
    final_oom=generate_table(metagenome_list, oomycete)
    final_oom.to_csv("./centifuge_output/centrifuge_metagenome_table_oom.txt", sep="\t")
    final_fung=generate_table(metagenome_list, fungi)
    final_fung.to_csv("./centifuge_output/centrifuge_metagenome_table_fungi.txt", sep="\t")
